...
- **Outputs:** `data_v2/cohort_{a,b}/vba/models/sd{Kp}sd{Kr1}sd{Krc}sd{Kwc}.mat`
...
- **Inputs:** `data_v2/cohort_{a,b}/vba/models/*.mat`
- **Outputs:**
  - `data_v2/cohort_{a,b}/vba/bma/bma_results.mat`: BMA group and summary results
  - `data_v2/cohort_{a,b}/vba/bma/free_energy.mat`: Free energy matrix (subjects x models)
...
- **Script:** `pipeline/vba/export.m`
- **Requires:** BMA results.
- **Inputs:** `data_v2/cohort_{a,b}/vba/bma/bma_results.mat`
- **Outputs** (all under `data_v2/cohort_{a,b}/vba/`):
  ...
  - `data_v2/cohort_{a,b}/subject_ids.csv`: Subject IDs
...
- **Requires:** `data_v2/cohort_{a,b}/vba/vba_input.xlsx`
- **Outputs:**
  - `data_v2/cohort_{a,b}/vba/cov_stats.mat`: Determinant and condition number per subject
  - `data_v2/cohort_{a,b}/vba/corr_preds.mat`: Recovered parameter correlation and covariance matrices
